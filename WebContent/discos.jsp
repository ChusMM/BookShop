	...
	<div id="wrapper">
		<div id="wrapper2">
			...
			<div id="page">
					<div id="content">				
						<div class="post">						
							<h2 class="title">Catálogo de discos</h2>
	                        	<div class="entry">
	                        	<%
								...
								if(cli != null) {%>
	                        		<div id="poptrox">
										...
										<ul id="gallery">                          
											...
											<s:iterator id="lista_articulo" value="discos" status="rowstatus">
											   <tr>	
											   <s:form action="AddCarrito" namespace="/" theme="simple">																		   	 
											   	 <td><a href="<s:property value="foto"/>"><img src="<s:property value="foto"/>" WIDTH=210 HEIGHT=210 title="<s:property value="nombre"/>" ALIGN="LEFT" alt="Imagen no encontrada" /></a></td>
											     <td>Nombre del disco: <s:property value="nombre"/><br></td>
											     <td>Artista: <s:property value="autor"/><br></td>
											     ...
											     <td>Estilo: <s:property value="categoria"/><br></td>											     
											     ...
											     <td><s:submit value="Añadir al carrito" align="left"/><br><br><br><br></td> 
