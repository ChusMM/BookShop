							...
							<h2 class="title">Carrito</h2>
								...
								if(cli != null) {%>
	                        		<div id="poptrox">
										...
										<ul id="gallery">
											<s:iterator value="articulos" status="index">
											<tr> 
											...
											<td>Descripcion: <s:property value="descripcion"/><br></td>
												<s:iterator value="cantidades[#index.index]" status="status">
														<td>Cantidad: <s:property/><br></td>
												</s:iterator>    
											<s:form action="QuitarDelCarro" namespace="/" theme="simple">
												<td><s:hidden name="id"/></td>
												<s:submit value="Quitar del carrito"/>
											</s:form>
											</tr><br><br><br>
											</s:iterator>		
											
											<s:form action="Pagar" namespace="/" theme="simple">
												<br><br>
												<td>Precio Total: <s:property value="precioTotal"/></td>
												<s:submit value="Pagar ahora"></s:submit>
											</s:form>																	
										</ul>
